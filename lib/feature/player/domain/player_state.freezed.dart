...
@override
int get hashCode => Object.hash(runtimeType,currentItem,audioStream,const DeepCollectionEquality().hash(availableParts),const DeepCollectionEquality().hash(queue),currentQueueIndex,queueSourceLabel,queueMode,isLoading,isReady,isPlaying,isBuffering,volume,position,bufferedPosition,duration,statusHint,errorMessage);

@override
String toString() {
  return 'PlayerState(currentItem: $currentItem, audioStream: $audioStream, availableParts: $availableParts, queue: $queue, currentQueueIndex: $currentQueueIndex, queueSourceLabel: $queueSourceLabel, queueMode: $queueMode, isLoading: $isLoading, isReady: $isReady, isPlaying: $isPlaying, isBuffering: $isBuffering, volume: $volume, position: $position, bufferedPosition: $bufferedPosition, duration: $duration, statusHint: $statusHint, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 PlayableItem? currentItem, AudioStreamInfo? audioStream, List<PlayableItem> availableParts, List<PlayableItem> queue, int? currentQueueIndex, String? queueSourceLabel, PlayerQueueMode queueMode, bool isLoading, bool isReady, bool isPlaying, bool isBuffering, double volume, Duration position, Duration bufferedPosition, Duration? duration, PlayerStatusHint? statusHint, String? errorMessage
});
...
/// Create a copy of PlayerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentItem = freezed,Object? audioStream = freezed,Object? availableParts = null,Object? queue = null,Object? currentQueueIndex = freezed,Object? queueSourceLabel = freezed,Object? queueMode = null,Object? isLoading = null,Object? isReady = null,Object? isPlaying = null,Object? isBuffering = null,Object? volume = null,Object? position = null,Object? bufferedPosition = null,Object? duration = freezed,Object? statusHint = freezed,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( PlayableItem? currentItem,  AudioStreamInfo? audioStream,  List<PlayableItem> availableParts,  List<PlayableItem> queue,  int? currentQueueIndex,  String? queueSourceLabel,  PlayerQueueMode queueMode,  bool isLoading,  bool isReady,  bool isPlaying,  bool isBuffering,  double volume,  Duration position,  Duration bufferedPosition,  Duration? duration,  PlayerStatusHint? statusHint,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlayerState() when $default != null:
return $default(_that.currentItem,_that.audioStream,_that.availableParts,_that.queue,_that.currentQueueIndex,_that.queueSourceLabel,_that.queueMode,_that.isLoading,_that.isReady,_that.isPlaying,_that.isBuffering,_that.volume,_that.position,_that.bufferedPosition,_that.duration,_that.statusHint,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( PlayableItem? currentItem,  AudioStreamInfo? audioStream,  List<PlayableItem> availableParts,  List<PlayableItem> queue,  int? currentQueueIndex,  String? queueSourceLabel,  PlayerQueueMode queueMode,  bool isLoading,  bool isReady,  bool isPlaying,  bool isBuffering,  double volume,  Duration position,  Duration bufferedPosition,  Duration? duration,  PlayerStatusHint? statusHint,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _PlayerState():
return $default(_that.currentItem,_that.audioStream,_that.availableParts,_that.queue,_that.currentQueueIndex,_that.queueSourceLabel,_that.queueMode,_that.isLoading,_that.isReady,_that.isPlaying,_that.isBuffering,_that.volume,_that.position,_that.bufferedPosition,_that.duration,_that.statusHint,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( PlayableItem? currentItem,  AudioStreamInfo? audioStream,  List<PlayableItem> availableParts,  List<PlayableItem> queue,  int? currentQueueIndex,  String? queueSourceLabel,  PlayerQueueMode queueMode,  bool isLoading,  bool isReady,  bool isPlaying,  bool isBuffering,  double volume,  Duration position,  Duration bufferedPosition,  Duration? duration,  PlayerStatusHint? statusHint,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _PlayerState() when $default != null:
return $default(_that.currentItem,_that.audioStream,_that.availableParts,_that.queue,_that.currentQueueIndex,_that.queueSourceLabel,_that.queueMode,_that.isLoading,_that.isReady,_that.isPlaying,_that.isBuffering,_that.volume,_that.position,_that.bufferedPosition,_that.duration,_that.statusHint,_that.errorMessage);case _:
  return null;
...
@override
int get hashCode => Object.hash(runtimeType,currentItem,audioStream,const DeepCollectionEquality().hash(_availableParts),const DeepCollectionEquality().hash(_queue),currentQueueIndex,queueSourceLabel,queueMode,isLoading,isReady,isPlaying,isBuffering,volume,position,bufferedPosition,duration,statusHint,errorMessage);
